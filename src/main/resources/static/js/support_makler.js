...
function loadTickets() {
    ...
    const tableBody = document.getElementById('ticketsTableBodyMakler');
...
function loadSummary() {
    ...
    document.getElementById('openTicketsMakler').textContent = '3';
    document.getElementById('inProgressTicketsMakler').textContent = '2';
    document.getElementById('solvedTicketsMakler').textContent = '15';
    document.getElementById('avgResponseTimeMakler').textContent = '4h';
}

function initializeEventListeners() {
    // Status-Filter
    document.getElementById('ticketStatusMakler').addEventListener('change', filterTickets);

    // Prioritäts-Filter
    document.getElementById('ticketPriorityMakler').addEventListener('change', filterTickets);

    // Kategorie-Filter
    document.getElementById('ticketCategoryMakler').addEventListener('change', filterTickets);

    // Suche
    document.getElementById('searchTicketsMakler').addEventListener('input', filterTickets);
}
